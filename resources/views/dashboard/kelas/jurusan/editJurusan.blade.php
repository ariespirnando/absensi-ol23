...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{route('jurusan')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
            class="fas fa-download fa-sm text-white-50"></i> Kembali</a>
</div>
@include('component.alert')
<form method="POST" action="{{route('jurusan.update.action')}}">
<div class="card shadow mb-4">
    ...
    @csrf
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="kode" placeholder="Kode Jurusan">
            </div>
        </div>
        <div class="form-group row">
